  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        {hasSidebar &&
          <div className={`${classes.sidebar} ${this.state.active ? 'active' : ''}`}>
            <button className={classes.close} onClick={() => this.setState({ active: !this.state.active })} />
        ...
        <div className={classes.hero}>
          ...
          <button className={classes.menu} onClick={() => this.setState({ active: !this.state.active })}>
          ...
          <div className={classes.heroContent}>
            ...
            <img className={classes.image} src="./img/hero.svg" alt="sugUI Design System" />
          </div>
        </div>
